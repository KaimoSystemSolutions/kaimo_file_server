...
public partial class Departments
{
    ...
    private async Task Select(Department dept) { CloseDropdowns(); _activeTab = DepartmentDetailTab.General; await VM.SelectAsync(dept); StateHasChanged(); }
    ...
    private void SwitchTab(DepartmentDetailTab tab) { CloseDropdowns(); _activeTab = tab; }
