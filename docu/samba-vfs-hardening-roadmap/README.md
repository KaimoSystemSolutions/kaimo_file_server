...
> **Most recently completed:** P2-14 – Remove development credentials from operational paths
> **Next planned finding:** P2-15 – Enforce Samba version and VFS ABI pinning in CI
